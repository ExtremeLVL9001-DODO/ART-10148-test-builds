...
public class PushBotManualArcade2 extends PushBotTelemetry
{
    //--------------------------------------------------------------------------
    //
    // PushBotManual
...

    {
        ...
        //
        float leftStickY = -(gamepad1.left_stick_y*gamepad1.left_stick_y*gamepad1.left_stick_y);
        float rightStickX = -(gamepad1.right_stick_x*gamepad1.right_stick_x*gamepad1.right_stick_x);
        ...
        float minmaxleftdrive = Math.max(Math.min( leftStickY - rightStickX, 1), -1);
        float minmaxrightdrive = Math.max(Math.min( leftStickY + rightStickX, 1), -1);


        //
        // Manage the arm motor.
        //
        float l_gp2_left_stick_y = -(gamepad2.left_stick_y*gamepad2.left_stick_y*gamepad2.left_stick_y);
...
/*
        ...
        if (partybutton==true){
            ...
            // sets the bot spinning based on randomised speed
              minmaxleftdrive = movement;
              minmaxrightdrive = -(  movement);

            //waves arm up and down randomly
            float 1_left_arm_power = double movement;
